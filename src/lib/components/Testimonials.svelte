    ...
    <div class="wrapper py-20 px-10">   
        <div class="flex md:justify-between lg:max-w-[1024px] lg:m-auto">
            <div class="w-full h-full m-auto pr-10">
                ...
                <p class="font-semibold">- Borat Jensen</p>

                <div class="flex gap-[6px] place-content-center pt-6">
                    <div class="w-2 h-2 rounded-full bg-yellowdot"></div>
                    <div class="w-2 h-2 rounded-full bg-white border border-darkblue"></div>
                    <div class="w-2 h-2 rounded-full border border-darkblue"></div>
                    <div class="w-2 h-2 rounded-full border border-darkblue"></div>
                    <div class="w-2 h-2 rounded-full border border-darkblue"></div>
                </div>
