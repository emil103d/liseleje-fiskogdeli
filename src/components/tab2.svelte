...
<div class="sideboxRight flex bg-lightblue p-4 min min-h-full">
	<ul class="self-center md:pl-32">
		<li>
			<a class="hover-underline-animation" href="/construction">Julefrokost 2022</a>
		</li>
		<li>
			<a class="hover-underline-animation" href="/construction">Nytårsmenuer</a>
		</li>
		<li>
			<a class="hover-underline-animation" href="/construction">Selskabsmenuer</a>
		</li>
		<li>
			<a class="hover-underline-animation" href="/construction">Alle menuer</a>
		</li>
	</ul>
</div>
...
<style>
	...
	.hover-underline-animation {
		...
		-webkit-mask: linear-gradient(#000 0 0) top / 100% calc(100% - 12px),
